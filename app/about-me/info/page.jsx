...
const InfoSub = (
  <Image src="/info/infoSub.svg" height={14} width={14} alt="infoSub" />
);
const bio = <Image src="/info/bio.svg" height={14} width={14} alt="bio" />;
const interest = (
  <Image src="/info/interest.png" height={14} width={14} alt="interest" />
);
const education = (
  <Image src="/info/eduaction.png" height={14} width={14} alt="education" />
);
const email = (
  <a href="mailto:hasanmdmahedi193@gmail.com">hasanmdmahedi193@gmail.com</a>
);
const items = [
