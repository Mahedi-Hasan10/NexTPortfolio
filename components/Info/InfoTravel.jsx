    ...
    return (
        <div className="flex">
             <div className="w-full flex gap-[20px]  p-8 text-[#607B96] lg:text-[18px] text-[16px] font-[450]">
                ...
                <p className="flex items-center">While my professional journey <br /> has kept me primarily rooted in
                the digital realm, my strong passion for traveling fuels my
                curiosity about exploring diverse cultures and landscapes
                As of now, my travel experiences may be limited, but my
                enthusiasm to <br />
                embark on new adventures knows no bounds. <br /> I am eagerly
                anticipating the
                opportunities to broaden my horizons and create lasting memories
                through travel
                and turning ideas into tangible, functional products. 
                Stay tuned for future updates on my travel escapades!</p>
                </div>
            </div> 
        </div>
    );
