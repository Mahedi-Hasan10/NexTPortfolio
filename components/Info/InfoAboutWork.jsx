    ...
    <div className="flex">
      <div className="w-full flex gap-[20px]  p-8 text-[#607B96] lg:text-[18px] text-[16px] font-[450]">
        ...
        <div className="grid grid-cols-1 gap-1 items-center">
          <p>
            In the last one years, I&apos;ve dedicated myself to mastering the
            art of Full Stack Web Development. Through hands-on experience with
            diverse technologies and frameworks, I&apos;ve honed my skills to
          ...
          <p>
            ...
            commodo consequat. Duis aute irure dolor in reprehenderit in I
            thrive on challenges, solving problems, and turning ideas into
